  ...
  return (
    <div className="bg-white rounded-lg p-6 w-[866px] relative">
      ...
      <div className="flex gap-3">
        ...
        <button
          className="bg-[#0158DE] text-white rounded-full px-4 py-2 text-sm flex items-center gap-1 ml-auto"
      ...
      {modalMode === "vote" && <VoteResCheck onClose={closeModal} />}
    </div>
  );
}
